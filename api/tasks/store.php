...
// Build folder path
$clientFolder = "{$SERVER_CUS_PATH}-clients/{$clientSysId}_{$clientName}/{$workSysId}"."+"."$workTitle";
$clientFolderName = "{$SERVER_CUS_PATH}-clients/{$clientSysId}_{$clientName}/{$workSysId}"."+"."$workTitle/tasks";
