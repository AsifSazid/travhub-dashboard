...
<head>
    ...
    <title><?php echo strtoupper($type) . 'Sections'; ?> - Petty Cash Management</title>
        ...
        <div class="p-4 md:p-6 h-full">
            ...
            <div class="mb-6">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Petty Cash Management</h1>
                        <p class="text-gray-600 mt-2">Manage and track all cash transaction in one place</p>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <a href="create-petty.php?type=<?php echo $type; ?>" class="bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800 text-white font-medium py-2.5 px-5 rounded-lg transition duration-300 flex items-center shadow">
                            <i class="fas fa-plus mr-2"></i> Create New <?php echo ucfirst($type) ; ?> 
                        </a>
                    </div>
                </div>
            </div>
