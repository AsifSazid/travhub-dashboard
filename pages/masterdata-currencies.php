...
<head>
    ...
    <title>Currencies & FX Rates — TravHub</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <script src="../assets/js/md-currencies.js?t=<?php echo time(); ?>"></script>
    <script>document.addEventListener('DOMContentLoaded', () => MdCurrencies.init());</script>
</body>
</html>