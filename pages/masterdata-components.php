...
<head>
    ...
    <title>Components — TravHub</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <script src="../assets/js/md-components.js?t=<?php echo time(); ?>"></script>
    <script>document.addEventListener('DOMContentLoaded', () => MdComponents.init());</script>
</body>
</html>