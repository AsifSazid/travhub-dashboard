...
<body class="bg-gray-50 font-sans">
    ...
    <script src="../assets/js/md-transport.js?t=<?php echo time(); ?>"></script>
    <script>document.addEventListener('DOMContentLoaded', () => MdTransport.init());</script>
</body>
</html>