    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function submitTransaction() {
                ...
                // 1. Create helper boolean flags for cleaner ternary logic
                ...
                const data = {
                    ...
                    amount: Number(amountInput?.value) || 0, // Cast to number to avoid string payload issues
                    ...
                    related_type_for_stmt: '1',
                    related_type_for_finen: isClientOrVendor ? 3 : 5
                };
