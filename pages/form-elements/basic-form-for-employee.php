    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-4">
            <h3 class="text-lg font-semibold text-gray-800 border-b pb-2">Company Related Information</h3>
            ...
            <div>
                ...
                <input type="text" id="fullName" name="full_name"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="John" required>
                <p class="text-xs text-gray-500 mt-1">Designation</p>
            </div>
            <div>
                <label for="fullName" class="block text-sm font-medium text-gray-700 mb-1">
                    Company Role <span class="text-red-500">*</span>
                </label>
                <textarea type="text" id="fullName" name="full_name"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Role in this Company" required></textarea>
                <p class="text-xs text-gray-500 mt-1">Company Role</p>
            </div>
            <div>
                <label class="block text-gray-700 mb-2">Date of Join *</label>
                <input type="date" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" data-field="dateOfJoin" min="2026-01-20">
            </div>
        </div>
