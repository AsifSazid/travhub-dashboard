...
<head>
        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    animation: {
                        'float-slow': 'float 45s linear infinite',
                        'float-medium': 'float 35s linear infinite',
                        'float-fast': 'float 25s linear infinite',
                        'plane-fly-slow': 'planeFlySlow 50s linear infinite',
                        'plane-fly-medium': 'planeFlyMedium 40s linear infinite',
                        'plane-fly-fast': 'planeFlyFast 30s linear infinite',
                        'plane-reverse': 'planeReverse 55s linear infinite',
    ...
    <style>
        * {
        ...
        /* Clouds Animation - ONLY in Hero - FIXED POSITIONING */
        .cloud {
            position: absolute;
            opacity: 0.15;
            filter: blur(2px);
        ...
        /* Planes Animation - FIXED POSITIONING AND ANIMATION */
        .plane {
            position: absolute;
            font-size: 2rem;
            opacity: 0.3;
        ...
        .plane-large {
            ...
            top: 20%;
            left: -100px;
            animation: planeFlyFast 30s linear infinite;
            opacity: 0.4;
        }
        ...
        .plane-medium {
            ...
            top: 40%;
            left: -150px;
            animation: planeFlyMedium 40s linear infinite;
            animation-delay: 8s;
        }
        ...
        /* Plane going in reverse direction - FIXED */
        .plane-reverse {
            font-size: 2.8rem;
            top: 30%;
            right: -100px;
            ...
            opacity: 0.25;
            animation: planeReverse 55s linear infinite;
            animation-delay: 20s;
        }
        
        /* Keyframes for animations - FIXED TO WORK PROPERLY */
        @keyframes float {
            0% { 
        ...
        @keyframes float-fast {
            ...
            100% { 
                transform: translateX(calc(100vw + 150px)) translateY(-3px); 
            }
        }
        ...
        @keyframes planeFlyMedium {
            0% { 
                transform: translateX(-150px) rotate(-3deg) translateY(10px); 
            }
            100% { 
                transform: translateX(calc(100vw + 150px)) rotate(-3deg) translateY(10px); 
            }
        }
        
        @keyframes planeFlySlow {
            0% { 
                transform: translateX(-200px) rotate(2deg) translateY(-5px); 
            }
            100% { 
                transform: translateX(calc(100vw + 200px)) rotate(2deg) translateY(-5px); 
            }
        }
        
        /* Reverse direction plane - FIXED */
        @keyframes planeReverse {
            0% { 
                transform: translateX(calc(100vw + 100px)) rotateY(180deg) rotate(3deg); 
            }
            100% { 
...
<body class="font-poppins">
    ...
    <div class="hero-container">
        ...
        <div class="container mx-auto px-2 py-2 content-z">
            <div class="flex pb-2">
                ...
                <div class="service-pill rounded-2xl flex md:hidden mx-auto">
        ...
        <!-- Hero Content -->
        <section class="container mx-auto px-4 py-12 md:pt-28 content-z">
    ...
    <footer class="footer-dark py-12">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div class="newsletter-section">
                    ...
                    <div class="newsletter-input-wrapper">
                        <input type="email" placeholder="Your email" class="newsletter-input px-4 py-3 bg-primary/30 border border-gray-700 rounded-l-lg text-white focus:outline-none focus:border-secondary transition duration-300">
            ...
            <div class="border-t border-gray-800 pt-8 text-center text-gray-500 mb-16">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // TEST ANIMATIONS
            // ======================
            console.log("Animations should be working now!");
            console.log("Planes and clouds are positioned properly with correct animations.");
        });
    </script>
</body>
</html>