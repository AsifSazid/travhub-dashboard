...
<body class="bg-gray-50 font-sans">
    ...
    <script src="../assets/js/md-countries.js?t=<?php echo time(); ?>"></script>
    <script>document.addEventListener('DOMContentLoaded', () => MdCountries.init());</script>
</body>
</html>