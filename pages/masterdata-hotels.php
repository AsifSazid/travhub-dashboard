...
<body class="bg-gray-50 font-sans">
    ...
    <script src="../assets/js/md-hotels.js?t=<?php echo time(); ?>"></script>
    <script>document.addEventListener('DOMContentLoaded', () => MdHotels.init());</script>
</body>
</html>