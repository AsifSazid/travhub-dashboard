...
<body class="bg-gray-50 font-sans">
    ...
    <script src="../assets/js/md-suppliers.js?t=<?php echo time(); ?>"></script>
    <script>document.addEventListener('DOMContentLoaded', () => MdSuppliers.init());</script>
</body>
</html>