...
<head>
    ...
    <title>Payments Report | TravHub Global Limited</title>
...
<body class="bg-gray-50 text-navy">
    ...
    <main id="mainContent" class="pt-16 pl-0 lg:pl-64 lg:my-16 transition-all duration-300 h-full">
        <div class="max-w-7xl mx-auto p-4 md:p-6">
          ...
          <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
            <div>
              <h1 class="text-xl md:text-2xl font-semibold text-navy">Payments Report</h1>
              <p class="text-sm text-gray-500">Source: ac_banking_stmts &middot; related_type = payment</p>
            </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div class="bg-white rounded-xl border border-gray-100 p-4">
              <p class="text-xs text-gray-400 mb-1">Total Payments (filtered)</p>
    ...
    (function () {
      ...
      const API = '/api/reports/payment/endpoints.php';
      ...
      function renderTable(rows) {
        ...
        if (!rows.length) {
          tbody.innerHTML = `<tr><td colspan="8" class="text-center py-6 text-gray-400">No payments found.</td></tr>`;
          return;
        }
      ...
      async function runExport(type, scope) {
        ...
        try {
          ...
          const filenameBase = `payments-report-${scope}-${new Date().toISOString().slice(0,10)}`;
