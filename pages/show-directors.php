...
// $showDirectorApi = $ip_port . "api/directors/show.php";
$getDirectorApi = $ip_port . "api/directors/get-director.php?director_id=$directorId";
...
<head>
    ...
    <title>Director Portfolio - <?php echo htmlspecialchars($directorId ?? 'Director'); ?></title>
...
<body class="bg-gray-50 font-sans">
    ...
    <main id="mainContent" class="pl-64 transition-all duration-300">
        <div class="p-6">
            ...
            <div id="loadingContainer" class="bg-white rounded-lg shadow p-8 text-center">
                ...
                <p class="mt-4 text-gray-600">Loading director information...</p>
            </div>
                ...
                <div class="portfolio-header mb-6 p-8 relative">
                    <div class="flex flex-col md:flex-row items-center md:items-start">
                        ...
                        <div class="flex-1 text-center md:text-left">
                            <h1 id="directorName" class="text-3xl md:text-4xl font-bold mb-2">Director Name</h1>
                            <h2 id="directorDesignation" class="text-xl md:text-2xl text-blue-100 mb-3">Designation</h2>
                            <div class="flex flex-wrap justify-center md:justify-start gap-4 text-blue-100 mb-6">
                                <div class="flex items-center">
                                    <i class="fas fa-id-card mr-2"></i>
                                    <span id="directorId">EMP-0000000</span>
                                </div>
                            </div>
                            
                            <!-- Contact Info -->
                            <div class="flex flex-wrap justify-center md:justify-start gap-4">
                                <a id="directorEmail" href="#" class="flex items-center bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg transition">
                                    <i class="fas fa-envelope mr-2"></i>
                                    <span>Email</span>
                                </a>
                                <a id="directorPhone" href="#" class="flex items-center bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg transition">
                                    <i class="fas fa-phone mr-2"></i>
                                    <span>Phone</span>
                                </a>
                                <a id="directorLocation" href="#" class="flex items-center bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg transition">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="info-card personal p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <div class="detail-label">Director ID</div>
                                ...
                                <div>
                                    <div class="detail-label">Director Type</div>
                                    <div id="directorType" class="detail-value">Not available</div>
                                </div>
                            </div>
                            <div class="mt-6">
                        ...
                        <div class="info-card p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        <div class="detail-value">Director Created</div>
            ...
            <div id="errorContainer" class="bg-white rounded-lg shadow p-8 text-center hidden">
                ...
                <h3 class="text-xl font-bold text-gray-800 mt-4">Error Loading Director Data</h3>
                <p id="errorMessage" class="text-gray-600 mt-2">Could not load director information. Please try again.</p>
    ...
    <script>
        const GET_DIRECTOR_INFO_API = "<?php echo $getDirectorApi; ?>";
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Function to fetch and display director data
            async function loadDirectorData() {
                try {
                    ...
                    if (data.success && data.director) {
                        ...
                        // Parse JSON fields
                        const emailData = parseJsonField(director.email) || {};
                        const phoneData = parseJsonField(director.phone) || {};
                        const addressData = parseJsonField(director.address) || {};
                        const basicInfoData = parseJsonField(director.basic_info) || {};
                        const emergencyContactData = parseJsonField(director.emergency_contact) || {};
                        const companyInfoData = parseJsonField(director.company_related_info) || {};
                        const metaData = parseJsonField(director.meta_data) || {};
                        
                        // Set profile photo (if available)
                        const profilePhoto = document.getElementById('profilePhoto');
                        if (director.image_name) {
                            try {
                                const imageData = JSON.parse(director.image_name);
                        ...
                        statusBadge.textContent = director.status || 'Unknown';
                        statusBadge.className = `status-badge ${director.status === 'active' ? 'status-active' : 'status-inactive'}`;
                        
                        // Header section
                        document.getElementById('directorName').textContent = director.name || 'Unknown';
                        document.getElementById('directorId').textContent = director.sys_id || 'DIR-0000000';
                        
                        // Designation
                        const designation = companyInfoData.designation || 'Director';
                        document.getElementById('directorDesignation').textContent = designation;

                        // Contact links in header
                        const emailLink = document.getElementById('directorEmail');
                        ...
                        const phoneLink = document.getElementById('directorPhone');
                        ...
                        const locationLink = document.getElementById('directorLocation');
                        ...
                        // About section
                        document.getElementById('sysId').textContent = director.sys_id || 'EMP-0000000';
                        ...
                        document.getElementById('directorType').textContent = director.type ? director.type.charAt(0).toUpperCase() + director.type.slice(1) : 'Not available';
                        ...
                        if (director.department_name) {
                            skillsContainer.innerHTML = '';
                            // Add department-specific skills
                            let skills = [];
                            
                            if (director.department_name === 'IT') {
                                skills = ['Software Development', 'System Analysis', 'Database Management', 'Web Technologies', 'Problem Solving'];
                            } else if (director.department_name === 'HR') {
                                skills = ['Recruitment', 'Director Relations', 'Training & Development', 'HR Policies', 'Communication'];
                            } else if (director.department_name === 'Finance') {
                        ...
                        throw new Error('Invalid director data received');
                    }
                } catch (error) {
            ...
            // Load director data on page load
            loadDirectorData();
            
            // Retry button functionality
            retryButton.addEventListener('click', loadDirectorData);
            ...
            document.getElementById('editButton').addEventListener('click', function() {
                alert('Edit functionality would open a form to update director information.');
