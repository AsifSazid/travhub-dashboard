...
<head>
    ...
    <title>Activities — TravHub</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <script src="../assets/js/md-activities.js?t=<?php echo time(); ?>"></script>
    <script>document.addEventListener('DOMContentLoaded', () => MdActivities.init());</script>
</body>
</html>