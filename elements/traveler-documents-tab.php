<?php
/**
 * TravHub Smart Upload v3 — Documents Tab Element
 * ================================================
 * Renders inside show-travelers.php as a tab section.
 *
 * Expects in scope:
 *   $traveler  — full traveler row (must include sys_id, summary, summary_dirty, summary_updated_at)
 *   $pdo       — PDO connection
 *
 * Features:
 *   - Live summary panel (parsed from travelers.summary JSON)
 *   - "Regenerate Summary" button (calls regenerate-summary.php with trigger=manual)
 *   - "Smart Upload" button (links to smart-upload.php)
 *   - Documents grouped by doc_type, with thumbnails + expiry badges
 *   - Expiring-soon strip at top (red for expired, amber for ≤30 days)
 */
...
<div id="documents-tab" class="space-y-6">
